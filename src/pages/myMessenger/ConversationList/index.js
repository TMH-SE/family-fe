...
export default function ConversationList(props) {
    ...
    const newConversations = [
      {
        idChat: 'chat1',
        photo:
          'https://scontent-hkg4-1.xx.fbcdn.net/v/t1.0-9/s960x960/69272993_1239809152868423_6499525428661714944_o.jpg?_nc_cat=109&_nc_sid=85a577&_nc_ohc=EjOMARIw2YsAX-GtsO1&_nc_ht=scontent-hkg4-1.xx&_nc_tp=7&oh=e2211383674fc732817aea26a9f872b2&oe=5EE91203',
        name: 'tuihieune'
        // lastMess: null
      ...
      },
      {
        idChat: 'chat2',
        photo:
          'https://scontent-hkg4-1.xx.fbcdn.net/v/t1.0-9/51513455_1368942463269403_2374620841670344704_n.jpg?_nc_cat=107&_nc_sid=85a577&_nc_ohc=6lWHYOfeVH8AX8u5Ct1&_nc_ht=scontent-hkg4-1.xx&oh=5131de2270df5deadcac47b1ee5b9206&oe=5EEB167C',
        name: 'tuikyne'
        // lastMess: null
        // text:
  ...
  const selectHandler = conversation => {
    ...
    firebase
      .database()
      .ref('messenger/' + conversation.idChat)
  ...
  return (
    <div className="conversation-list">
      ...
      <List
        ...
        // loadMore={loadMore}
        dataSource={conversations.sort(
          (a, b) => b.lastMess.timestamp - a.lastMess.timestamp
        )}
